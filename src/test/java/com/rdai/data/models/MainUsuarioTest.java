...
class MainUsuarioTest {
    ...
    private Optional<UsuarioEntity> crearUsuarioTest() {
        ...
        return Optional.of( UsuarioEntity.builder().id(1).nombreUsuario("santivelez1012")
                .password("321654").nombreCompleto("Santiago Vélez").pais("Colombia")
                .ciudad("Caldas").rolEntity(roles).build() );
    }
